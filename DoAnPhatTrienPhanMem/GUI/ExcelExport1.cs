...
namespace GUI
{
    public class ExcelExport1
    {
        ...
        public const string T_DanhMucKhoa = "HoaDon1";
        #endregion
        ...
        public bool ExportHD(List<Class1> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            return OutSimpleReport(dataSource, replacer, "HoaDon1", isPrintPreview, ref fileName);
        }
        #endregion
